...
public class AircraftReserveInfoController {
   ...
   */
  @PostMapping()
  public ResponseEntity<AircraftReserveInfoResponseDto> post(
      @RequestBody AircraftReserveInfoRequestDto dto,
    ...
    // サービス呼び出し
    AircraftReserveInfoResponseDto responseDto = service.postData(dto, userDto);
   ...
   */
  @PutMapping()
  public ResponseEntity<AircraftReserveInfoResponseDto> put(
      @RequestBody AircraftReserveInfoRequestDto dto,
      @AuthenticationPrincipal UserInfoDto userDto) {
    ...
    // サービス呼び出し
    AircraftReserveInfoResponseDto responseDto = service.putData(dto, userDto);
   ...
   */
  @GetMapping("/list")
  public ResponseEntity<AircraftReserveInfoListResponseDto> getList(
      @QueryStringArgs AircraftReserveInfoListRequestDto dto) {
  ...
  public ResponseEntity<AircraftReserveInfoListResponseDto> getPublicDataExtract(
      @QueryStringArgs AircraftReserveInfoListRequestDto dto) {
    logger.info("機体予約公開データ抽出:  ===== START =====");
    logger.debug(dto.toString());
   ...
   * 機体予約詳細
   *
   * @param aircraftReserveId 予約ID(パスパラメータ)
   * @return 正常終了レスポンス
   */
  @GetMapping("/detail/{aircraftReserveId}")
  public ResponseEntity<AircraftReserveInfoDetailResponseDto> getDetail(
   ...
   *
   * @param aircraftReserveId 予約ID(パスパラメータ)
   * @param aircraftReservationIdFlag 機体予約ID使用フラグ(クエリパラメータ)
   * @param userDto 認可ユーザー情報
   */
  @DeleteMapping("/{aircraftReserveId}")
  public void delete(
      @PathVariable("aircraftReserveId") String aircraftReserveId,
      @RequestParam(value = "aircraftReservationIdFlag", required = false, defaultValue = "false")
          Boolean aircraftReservationIdFlag,
      @AuthenticationPrincipal UserInfoDto userDto) {
    ...
    // サービス呼び出し
    service.deleteData(aircraftReserveId, aircraftReservationIdFlag, userDto);
