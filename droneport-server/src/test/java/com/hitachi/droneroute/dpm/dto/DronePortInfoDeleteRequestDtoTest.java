...
/** DronePortInfoDeleteRequestDtoTestの単体テスト */
public class DronePortInfoDeleteRequestDtoTest {
  ...
  void testToString() {
    ...
    String expected = "DronePortInfoDeleteRequestDto(operatorId=operator123)";
